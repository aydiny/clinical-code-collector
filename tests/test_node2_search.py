...
TEST_CASES = [
    {
        "name": "TC1_HFrEF",
        "state": {
            "search_terms":        ["heart failure reduced ejection fraction", "HFrEF"],
            "concept_type":        "diagnosis",
            "explicit_exclusions": ["acute", "right-sided"],
        },
        "expect_present":  ["703272007"],   # must appear in candidates
        "expect_absent":   ["44054006"],                 # T2DM must NOT appear
        "min_candidates":  5,
    },
    {
        "name": "TC2_T2DM",
        "state": {
            "search_terms":        ["type 2 diabetes mellitus", "T2DM"],
            "concept_type":        "diagnosis",
    ...
    },
    {
        "name": "TC3_AF",
        "state": {
            "search_terms":        ["atrial fibrillation"],
            "concept_type":        "diagnosis",
            "explicit_exclusions": [],
        },
        "expect_present":  ["49436004", "426749004", "282825002"],
        "expect_absent":   ["44054006"],
        "min_candidates":  5,
    },
]
