OPENCODELISTS_INDEX = {
    ...
    # ── HFrEF / LV systolic dysfunction support ──────────────────────────────
    # These are positive subtype-supporting NHSD public refsets on OpenCodelists.
    "hfrEF": [
        {
        ...
        {
            "name": "NHSD Heart Failure due to LV Systolic Dysfunction Codes",
            "org":  "nhsd-primary-care-domain-refsets",
    ...
    "atrial fibrillation": [
        {
            "name": "NHSD Atrial Fibrillation Codes",
            "org":  "nhsd-primary-care-domain-refsets",
    ...
    "obesity": [
        {
            "name": "NHSD BMI Obese Codes",
            "org":  "nhsd-primary-care-domain-refsets",
            "url":  "https://www.opencodelists.org/codelist/nhsd-primary-care-domain-refsets/bmiobese_cod/20250912/download.csv",
        },
    ],
}
